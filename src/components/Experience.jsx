...
const Experience = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      location: 'Hyderabad, India',
      description: 'Organized technical competitions and mathematical events for the student community.',
      bullets: [
        'Organized technical competitions and mathematical events',
        'Coordinated logistics and event execution',
        'Led operational planning for academic activities',
      ],
    },
    {
      ...
      location: 'Hyderabad, India',
      description: 'Coordinated event logistics and speaker operations for a 500+ attendee event.',
      bullets: [
        'Coordinated on-ground logistics and event execution',
        'Assisted in large-scale speaker and operations management',
        'Collaborated across teams for event coordination',
      ],
    },
    {
      title: 'Participant',
      ...
      description: 'Collaborated in a team of 6 to prototype an intelligent system solution.',
      bullets: [
        'Participated in collaborative technical problem-solving',
        'Worked on solution ideation and prototyping',
      ],
    },
  ];
